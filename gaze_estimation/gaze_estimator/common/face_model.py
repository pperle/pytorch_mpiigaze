...
class FaceModel:
    ...
    def __init__(self, config: yacs.config.CfgNode):
        ...
        if self.mode == 'dlib':
            self.LANDMARKS: np.ndarray = np.array([
            ...
            self.REYE_INDICES: np.ndarray = np.array([36, 39])
            self.LEYE_INDICES: np.ndarray = np.array([42, 45])
            self.MOUTH_INDICES: np.ndarray = np.array([48, 54])

            self.CHIN_INDEX: int = 8
            self.NOSE_INDEX: int = 30
            ...
            self.MOUTH_INDICES: np.ndarray = np.array([61, 291])

            self.CHIN_INDEX: int = 199
            self.NOSE_INDEX: int = 1
        else:
            raise ValueError
